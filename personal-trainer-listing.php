        ...
        <?php for($gym=0; $gym < $total_trainer; $gym++ ){ ?>
          <div class="search_result_row">
            <div class="search_result_block search_result_image_block for_pt_img_block">
              <div class="search_tag">Trainer Image</div>
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="search_td"><?php                	
                	$img="trainer_logo/small/".$result[$gym]['logo_name'];
											
					if(!file_exists($img) || trim($result[$gym]['logo_name']) == NULL)
						$img="images/trainer-no-image.jpg";
					?>
					<img src="<?=$img?>" /></td>
                </tr>
              </table>
            ...
            <div class="search_result_block search_result_county_block for_pt_county">
              <div class="search_tag">Trainer Info</div>
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
            ...
            <div class="search_result_block search_result_description_block for_pt_descrip">
              <div class="search_tag">Trainer Experience</div>
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
            ...
            <div class="search_result_block search_result_area_block for_pt_area">
              <div class="search_tag">Specialties</div>
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="search_td">                	
                  	<ul>
					<?php
                  	$specialty="";					
                  	if(trim($result[$gym]['specialty1']) != NULL)
						$specialty .= "<li>" . trim($result[$gym]['specialty1']) ."</li> ";	
					if(trim($result[$gym]['specialty2']) != NULL)
						$specialty .= "<li>" . trim($result[$gym]['specialty2']) ."</li>";	
					if(trim($result[$gym]['specialty3']) != NULL)
						$specialty .= "<li>" . trim($result[$gym]['specialty3']) ."</li>";	
					if(trim($result[$gym]['specialty4']) != NULL)
						$specialty .= "<li>" . trim($result[$gym]['specialty4']) ."</li>";	
					if(trim($result[$gym]['specialty5']) != NULL)
						$specialty .= "<li>" . trim($result[$gym]['specialty5']) ."</li>";	
					echo $specialty;
            ...
            <div class="search_result_block search_price">
              <div class="search_tag">Price Per Session</div>
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
