...
$sql="select id,name,email_address,password from gyms where email_address='". $email_address ."' and email_confirmed=0 limit 1";
$result=$db->fetch_all_array($sql);

if((int)count($result) == 1){	
	$db->query("update gyms set email_confirmed=1,membership_type=2,last_login_date=now()  where  email_address='". $email_address ."'");	
	...
	$_SESSION['gym_email_address']=$result[0]['email_address'];	
	$_SESSION['gym_membership_type']=2;
