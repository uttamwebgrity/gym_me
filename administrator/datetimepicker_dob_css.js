...
var EndYear = 0; //End Year offset. i.e. Current Year + 5
...
var WeekHeadColor="#035aa3";//var WeekHeadColor="#586f47";//Background Color in Week header.
var SundayColor="#ffffff";//var SundayColor="#ffffff";//Background color of Sunday.
var SaturdayColor="#ffffff";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#d7d7d7";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#d7d7d7";//var SelDateColor="#1bb239";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#feadad"; //color when mouse move over.
