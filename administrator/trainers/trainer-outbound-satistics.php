  ...
  <tr>
    <td align="left" valign="top"><table border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="left" valign="middle" class="body_tab-middilebg">Trainers Outbound Satistics</td>
    ...
    <td align="left" valign="top" class="body_whitebg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php
				...
				$sql="select name,seo_link,website_URL,count(*) as total_outbound, count(DISTINCT user_ip) as unique_outbound ";
  				$sql .=" from trainer_outbound tb left join personal_trainers t on tb.trainer_id=t.id where seo_link IS NOT NULL";
...
cellpadding="5" cellspacing="1">
              ...
              <tr>
                ...
                <a href="trainers/trainer-outbound-satistics.php?display_oder=name&display_oder_type=<?=$display_oder_type?>" class="header_link">Trainer Name</a></td>
                ...
                <td width="75"  align="left" valign="middle" class="table_heading">
                	 <a href="trainers/trainer-outbound-satistics.php?display_oder=total&display_oder_type=<?=$display_oder_type?>" class="header_link">Total Outbound</a> </td>
                  <td width="75"  align="left" valign="middle" class="table_heading">
                  	 <a href="trainers/trainer-outbound-satistics.php?display_oder=unique&display_oder_type=<?=$display_oder_type?>" class="header_link">Unique Outbound</a></td>                
              </tr>
              ...
              <tr bgcolor="<?=$j%2==0?$general_func->color2:$general_func->color1;?>">
				...
				<td align="left" valign="middle" class="table_content-blue"><?=$general_func->site_url."personal-trainer/".$result[$j]['seo_link']?></td>                
