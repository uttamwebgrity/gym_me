...
if(isset($_GET['action']) && $_GET['action']=='delete'){		
	...
	$db->query_delete("contact_gym_message","id='".$_REQUEST['id'] ."'");
  ...
  <tr>
    <td align="left" valign="top" class="body_whitebg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <?php
				...
				$sql="select *  from contact_gym_message order by added_date DESC";			
...
cellpadding="5" cellspacing="1">
              ...
              <tr>
                <td width="100"  align="left" valign="middle" class="table_heading">Gym Name</a></td>  
